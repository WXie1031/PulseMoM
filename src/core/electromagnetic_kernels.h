...
typedef enum {
    KERNEL_G,                    // Green's function G
    KERNEL_GRAD_G,              // Gradient of Green's function ∇G
    KERNEL_G_R_R_PRIME,       // G/r² for specific integrals
    KERNEL_DOUBLE_GRAD_G     // Double gradient ∇∇G
} integral_kernel_t;
