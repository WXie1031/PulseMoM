...
#include "peec_circuit_coupling.h"  // Use peec_circuit_coupling.h (contains circuit_coupling_config_t and related types)
#include "../../io/analysis/enhanced_sparameter_extraction.h"
#include "../../solvers/mom/mom_solver.h"
#include "../../backend/solvers/sparse_direct_solver.h"  // TODO: Check if sparse_matrix.h exists or should use sparse_direct_solver.h
#include <stdlib.h>
#include <string.h>
#include <math.h>
#include <complex.h>
