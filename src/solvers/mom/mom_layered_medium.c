/******************************************************************************
 * MoM Solver with Layered Medium Support - Implementation
 ******************************************************************************/
...
/******************************************************************************
 * Internal Solver Extension
 ******************************************************************************/

// Extend mom_solver_t to include layered medium data
typedef struct {
    LayeredMedium* medium;
    GreensFunctionParams* greens_params;
    int application_mode;
    bool use_frequency_dependent_materials;
} mom_solver_layered_data_t;
...
int mom_solver_set_layered_medium(
    ...
    // Call the base mom_solver_set_layered_medium function
    // This function is declared in mom_solver.h and should be implemented
    // in the main MoM solver implementation
    
    // For now, this is a wrapper that validates inputs
    // The actual implementation would be in mom_solver_unified.c or similar
    ...
    // Call the actual implementation (would be in mom_solver implementation)
    // return mom_solver_set_layered_medium_impl(solver, medium, freq, greens_params);
...
int mom_solver_configure_pcb(
    ...
    int result = mom_solver_set_layered_medium(solver, medium, &freq, NULL);
...
int mom_solver_configure_antenna(
    ...
    // Layer 0: Air (top)
    medium->thickness[0] = 1.0;  // Large air layer
    ...
    // Layer 2: Air (bottom)
    medium->thickness[2] = 1.0;  // Large air layer
