...
#include <stdbool.h>
#include <math.h>
#include "types.h"  // Include types.h for fundamental type definitions
...
// Note: point3d_t and vector3d_complex_t are defined in types.h
...
// RWG basis function - moved to discretization/basis/rwg_basis.h (L2 layer)
// Use rwg_basis.h for RWG basis function definitions
...
// Error codes - Use status_t from types.h and CORE_* macros from errors.h
// core_error_t enum removed to avoid conflict with STATUS_* enum in types.h
// Use status_t for return types and CORE_* macros (defined in errors.h) for values
