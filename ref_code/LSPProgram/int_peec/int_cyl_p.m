function int = int_cyl_p(ps1, ps2, dv1, r1, pf1, pf2, dv2, r2, Nint)
%  Function:       int_cyl_p
%  Description:    Calculate intergral between two cylinders in
...
int(1:Nf) = 2*pi/2.*sum(AA.*(I1+I2),2) .* r12*2*pi;
