...
1/(4*pi*ep0)/len1/len1/dCshell * int_cyl_fila_p(ps1, ps2, dv1, r1, pf1, pf2, dv2, Nint) 
% cyliner shell - cyliner shell integration
1/(4*pi*ep0)/len1/len1/dCshell/dCshell * int_cyl_p(ps1, ps2, dv1, r1, pf1, pf2, dv2, r2, Nint)
...
1/(4*pi*ep0)./(len1*len1) .* int_fila_p(ps1,ps2,dv1,r1,pf1,pf2,dv2,r2)
