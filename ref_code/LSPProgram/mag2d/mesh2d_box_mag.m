function [Xs, Ys, ws, hs, dS, Rs, NVsr] = mesh2d_box_mag(pt_2d, wo, ho, Ro, mur, f0)
%  Function:       mesh2D_box
...
% shin depth
sig = 1e7; % conductivity

s_dep = 1./sqrt(pi*f0.*sig*mu0*mur) * ones(Nc,1);

Sr = wo.*ho;

%% 2. segment method
[NVw1, NVw2, NVh1, NVh2, NVs, w1, w2, h1, h2] = mesh2d_box_mag_sub( wo, ho, s_dep );
