function TE = multi_shield_t_e_pw(e_ang, zbdy, sig_lyr,mur_lyr,epr_lyr,w0)
%  Function:       multi_shield_t_e_pw
%  Description:    Calculate transmission coefficient of multilayer 
%                  shield for E field. Plane wave assumption. 
%                  Use characteristic impedance: Ze = k/(w*ep) Zh = (w*mu)/k
%                  
%                            region  0   1    2          N      N+1
