% TAPE_2_Sour_Py2  working horse for inte(1/R, x, y, z) -- (y')
%                  Level 1: z'
%                  Level 2: y'
%                  Level 3: x and y
...
% Dec. 2015
%
function f=G_T2SPy2(xf,yf,zf,xs,ys,zs)
[nf m]=size(xf);
[ns m]=size(xs);    % = size of ys
[nzf m]=size(zf);   % integration variable

XS=repmat(xs(1:ns,1)',nf,1);
...
% f1  
f1=G_T2SPy3(xf,yf,XS,YS1,dz);

% f2
f2=G_T2SPy3(xf,yf,XS,YS2,dz);
