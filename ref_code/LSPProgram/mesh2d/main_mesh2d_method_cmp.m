function [Rmesh,Lmesh,Pmesh, Rself,Lself, RmeshMF,LmeshMF] = main_mesh2d_method_cmp( ...
...
for ig = 1:Nf
    [RmeshMF(:,:,ig), LmeshMF(:,:,ig)] = cal_RL_mesh2d_method_cmp(...
        p2Dcir, rocir, ricir, Rpmcir, ...
        p2Drec, wrec, hrec, Rpmrec, ...
        p2Dagi, wagi, tagi, Rpmagi,  len(1), frq(ig));
end
