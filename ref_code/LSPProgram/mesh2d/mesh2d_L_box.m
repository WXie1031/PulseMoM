function [Xs,Ys, ws,hs, dS, Rs, NVsr] = mesh2d_L_box(pt_2d, wo,ho, Ro, f0)
%  Function:       mesh2D_L_box
%  Description:    Mesh box cross sections (2D). The centre of the box is
%                  diged out
%  Calls:          mesh2D_L_box_sub
...
%% 2. segment method
[NVw1,NVw2, NVh1,NVh2, NVs, w1,w2, h1,h2] = mesh2d_L_box_sub(wo,ho, s_dep);
