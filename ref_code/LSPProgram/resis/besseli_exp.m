function Isub = besseli_exp(nu,Z)
%  Function:       besseli_exp
%  Description:    Approximation formula for modified Bessel function of 
%                  first kind multipy exp(-Z). Can be used for extremely
%                  large Z input of special cases.
%
%  Calls:          
%
