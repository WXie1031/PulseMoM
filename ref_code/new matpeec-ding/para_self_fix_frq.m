function [Rmtx, Lmtx] = para_self_fix_frq(Rmtx, Lmtx, shape, dim1, dim2, ...
...
for ik = 1:Nc
    ...
    switch shape(ik)
        case 1002
            ...
            Rmtx(ik,ik) = max(Rin, R_pul(ik)*len(ik));
            
            if Lin_pul(ik)==0
                f0 = 5e3;
                Lmtx(ik,ik) = induct_bar_ac(dim1(ik), dim2(ik), ...
        ...
        case 1003
            ...
            if Lin_pul(ik)==0
                f0 = 5e3;
                Lmtx(ik,ik) = induct_agi_ac(dim1(ik), dim2(ik), ...
                    sig(ik), mur_tmp, len(ik), f0);
            else
                f0 = 5e6;
                Lmtx(ik,ik) = induct_agi_ac(dim1(ik), dim2(ik), ...
        ...
        otherwise
            ...
            Lmtx(ik,ik) = induct_cir_ext(dim1(ik), len(ik)) + Lin;
