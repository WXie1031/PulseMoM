function [Rmesh_pul, Lmesh_pul, Rself_pul, Lself_pul] = mesh2d_main_complete_pul(...
    shape, pt2D, dim1, dim2, Rin_pul, Lin_pul, mur, freq)
...
for ig = 1:Nf
    ...
    [RmeshMF_pul(:,:,ig), LmeshMF_pul(:,:,ig)] = cal_RL_mesh2d_complete(...
        p2Dcir, rocir, ricir, Rpmcir, murcir, ...
        p2Drec, wrec, hrec, Rpmrec, murrec, ...
        p2Dagi, wagi, tagi, Rpmagi, muragi, len_pul, freq(ig));
