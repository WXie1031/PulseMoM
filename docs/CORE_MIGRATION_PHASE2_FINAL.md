...
3. **Solvers层**: 
   ...
   - PEEC: `peec_triangular_mesh.c`, `peec_via_modeling.c/h`, `peec_integration.c`, `peec_geometry_support.c`, `peec_directionality_kernels.c/h`, `peec_solver_unified.c`, `peec_solver_min.c`, `peec_plane_wave.c`, `peec_non_manhattan_geometry.c`
