...
3. **Solvers层**: 
   - `mom_solver_unified.c`, `mom_solver_min.c`, `mom_aca.c/h`, `mom_hmatrix.h`, `mom_mlfmm.h`
   - `peec_triangular_mesh.c`, `peec_via_modeling.c/h`, `peec_integration.c`, `peec_geometry_support.c`, `peec_directionality_kernels.c/h`
   - `mtl_solver_module.h`, `mtl_hybrid_coupling.c`
   - `hybrid_solver.c`
